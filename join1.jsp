...
if(rs.next()){
	cn=DBMan.getConnection();
	PreparedStatement ps1=cn.prepareStatement("select * from joining");
...
<td><textarea type="text" name="address" required="required" width="40" height="50"></textarea></td></tr>
		<tr>
			...
			<td><select name="class1" required="required">
		...
		<tr>
			...
			<td>Hostel<input type="radio" name="accommodation" required="required"
		...
		<tr>
			...
			<td>By School Bus<input type="radio" name="vehicle" required="required"
...
I accept all the Terms and Conditions. </a>  </td></tr>
	<tr><td>admission number:</td><td><input type="hidden" value="<%=aid%>" name="usertype"></td></tr>
		<tr><td><input type="submit" value="Join" class="menulink"
